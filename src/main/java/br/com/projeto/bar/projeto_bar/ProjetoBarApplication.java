...
public class ProjetoBarApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido pedido1 = new Pedido("Do the L", StatusPedido.FINALIZADO, Mesa.N_1, funcionario1);
		pedidoRepository.save(pedido1);
		Pedido pedido2 = new Pedido("Do the 13", StatusPedido.FIADO, Mesa.N_1, funcionario2);
		pedido2.setCliente(cliente1);
		pedidoRepository.saveAll(Arrays.asList(pedido1, pedido2));
	
		ItemPedido itemPedido1 = new ItemPedido(pedido1, produto1, 5);
		ItemPedido itemPedido2 = new ItemPedido(pedido2, produto2, 5);
		itemPedidoRepository.saveAll(Arrays.asList(itemPedido1, itemPedido2));
	
		pedido1.setItemPedidos(Arrays.asList(itemPedido1, itemPedido2));
		pedidoRepository.save(pedido1);
	
		Pagamento pagamento1 = new Pagamento(TipoPagamento.DINHEIRO, null, pedido1);
		pagamento1.setValor(pedido1.getValorTotal());
